...
let CalendarController = class CalendarController {
    ...
    async callback(code, state, error) {
        ...
        if (!code) {
            throw new common_1.BadRequestException('Missing OAuth code from Google callback.');
        }
...
__decorate([
    ...
    (0, decorators_1.Roles)(client_1.AdminRole.SUPER_ADMIN, client_1.AdminRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get Google Calendar connection status (admin)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, decorators_1.Roles)(client_1.AdminRole.SUPER_ADMIN, client_1.AdminRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Disconnect Google Calendar (admin)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
