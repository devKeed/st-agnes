...
__decorate([
    (0, common_1.Patch)('calendar-id'),
    (0, decorators_1.Roles)(client_1.AdminRole.SUPER_ADMIN, client_1.AdminRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({
        summary: 'Update the connected Google Calendar ID without reconnecting OAuth (admin)',
    }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_calendar_id_dto_1.UpdateCalendarIdDto]),
    __metadata("design:returntype", void 0)
], CalendarController.prototype, "updateCalendarId", null);
__decorate([
